var vm = new Vue({
    ...
    data: {
        dbtype: 'oracle',			//数据库类型
        dbAddress: '39.106.205.249',		//连接地址
        dbport: 1521,				//端口
        username: 'gentler',			//用户名
        password: '1q2w3e4r',				//密码
        databaseName: 'paydb01',			//数据库名
        loading: false				//加载状态
    },
    ...
    methods: {
        ...
        //选择数据库
        selectDb: function () {
            this.dbAddress = '39.106.205.249';			//连接地址
            if ("mysql" == this.dbtype) {
                ...
                this.dbport = 1521;					//端口
                this.databaseName = 'paydb01';			//库名
                this.username = 'gentler';					//用户名
            } else {
                this.dbport = 1433;					//端口
