    ...
    methods: {
        ...
        init() {
            ...
            $('#tab_menu').contextPopup({
                ...
                items: [
                    {
                        label: '关闭全部标签', action: function () {
                            top.vm.indexTabClose('all');
                        }
                    },
                    {
                        label: '关闭当前标签', action: function () {
                            top.vm.indexTabClose('own');
                        }
                    },
                    {
                        label: '关闭其它标签', action: function () {
                            top.vm.indexTabClose('other');
                        }
                    }
                ]
            });
